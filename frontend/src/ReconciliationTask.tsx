    ...
    <div className="reconciliation-body">
      ...
      <div className="reconciliation-decision">
        {showResult && candidate ? <>
          ...
          {current.locator.kind === 'composition' && <p>{current.locator.reason === 'competing_children' ? 'Both diagrams must survive. Choose which stays on this parent, then explicitly assign the other diagram. You can also choose a complete manual assignment.' : 'Choose a complete valid arrangement for the affected facts. Check choices will identify any additional dependencies.'}</p>}

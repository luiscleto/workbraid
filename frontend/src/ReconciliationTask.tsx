...
type Value = { size?:{width:number;height:number}|null; position?:{x:number;y:number}|null; text?: string; count?: number; present?: boolean; diagram_id?: string; anchor_component_id?: string; homes?: Home[]; references?: Reference[]; detail_anchors?: Anchor[]; relationship_counts?: Count[] }
type Side = Value & { state?:'not_applicable'|'derived'|'stored'; exists?: boolean; component?: { title: string; description: string }; diagram?: { title: string } }

...
- Keep pending/in-progress plans and a concise roadmap. Remove superseded/completed plan files when authorized; preserve their history in Git and leave runtime evidence, private stores and unrelated user files alone.
